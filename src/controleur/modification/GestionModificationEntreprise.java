...
public class GestionModificationEntreprise implements ActionListener {
    ...
    public GestionModificationEntreprise(Fenetre_ModificationEntreprise modificationEntreprise) {
        ...
        // Initialisation de l'accès aux opérations de la base de données pour l'entreprise
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch (btn.getText()) {
            case "Modifier":
                try {
                    // Création d'un objet Entreprise avec les données saisies dans la fenêtre de modification
