        ...
        switch (btn.getText()) {
            case "Modifier":
                ...
                try {
                    ...
                    Louer louerM = new Louer(
                            louerBD.getLocataire(),
                            louerBD.getBien(),
                            fml.getTextField_date_debut().getText(),
                            louerBD.getNbMois(),
                            ...
                            Double.parseDouble(fml.getTextField_caution_TTC().getText()),
                            louerBD.getBail(),
                            louerBD.getEtat_lieux(),
                            fml.getTextField_date_depart().getText(),
                            Integer.parseInt(fml.getTextField_loyer_paye().getText()),
                            louerBD.getIcc(),
