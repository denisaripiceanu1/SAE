...
public class PDFImporter extends JFrame {
	...
	private void initializeComponents() {
		...
		btnImportPDF.addActionListener(e -> chemin.choisirChemin());
		this.setLayout(new FlowLayout());
		this.add(btnImportPDF);
	}

	public String getSelectedFilePath() {
		return this.chemin.getSelectedFilePath();
	}
	...
	public void importPDFBD(int id, String nom) throws FileNotFoundException, SQLException {
		...
		File pdfFile = new File(this.chemin.getSelectedFilePath());
	...
	public String getPDFFileName() {
		if (this.getSelectedFilePath() != null && !this.getSelectedFilePath().isEmpty()) {
			return new File(this.getSelectedFilePath()).getName();
		}
		return null;
	}
}
