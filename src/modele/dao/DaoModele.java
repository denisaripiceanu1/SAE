...
public abstract class DaoModele<T> implements Dao<T> {
	...
	protected List<T> find(Requete<T> requete, String... id) throws SQLException {
		try(PreparedStatement st = CictOracleDataSource.getConnectionBD().prepareStatement(requete.requete())){
	...
	// Méthodes de l'interface Dao<T>

	@Override
	public abstract void create(T donnees) throws SQLException;

	@Override
	public abstract void update(T donnees) throws SQLException;

	@Override
	public abstract void delete(T donnees) throws SQLException;
