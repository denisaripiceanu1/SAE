...
/**
 * Classe représentant un sous-programme SQL pour l'insertion d'une location (Louer).
 *
 * @param donnee Objet Louer contenant les données de la location à insérer.
 */
public class SousProgrammeInsertLocation implements SousProgramme<Louer> {

    /**
     * Retourne l'appel du sous-programme SQL pour l'insertion d'une location.
     *
     * @return Appel du sous-programme SQL pour l'insertion d'une location.
     */
	@Override
    ...
    /**
     * Paramètre la PreparedStatement avec les valeurs de la location à insérer (non implémenté).
     *
     * @param prSt       PreparedStatement à paramétrer.
     * @param parametres Paramètres de la location à insérer.
    ...
    /**
     * Paramètre la PreparedStatement avec les valeurs de l'objet Louer pour l'insertion.
     *
     * @param prSt  PreparedStatement à paramétrer.
     * @param donnee Objet Louer contenant les données de la location à insérer.
     * @throws SQLException Si une erreur SQL survient lors du paramétrage de la requête.
