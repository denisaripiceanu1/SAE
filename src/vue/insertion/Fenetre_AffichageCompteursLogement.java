...
public class Fenetre_AffichageCompteursLogement extends JInternalFrame {
    ...
    public Fenetre_AffichageCompteursLogement() {
        ...
        createButton("Annuler", 149, 369, 94, 31, "Annuler", panel);
        createButton("Ajouter un relevé", 491, 369, 166, 31, "AjouterReleve", panel);
        createButton("Afficher les relevés", 287, 369, 166, 31, "AfficherReleves", panel);
    }
    ...
    private JButton createButton(String label, int x, int y, int width, int height, String actionCommand, JPanel panel) {
        ...
        button.addActionListener(this.gestionAffichage);
        panel.add(button);
        return button;
    }
