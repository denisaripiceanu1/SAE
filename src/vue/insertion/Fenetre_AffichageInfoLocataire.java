...
public class Fenetre_AffichageInfoLocataire extends JInternalFrame {
    ...
    public Fenetre_AffichageInfoLocataire() {
        ...
        textField_Telephone.setBorder(new TitledBorder(new LineBorder(new Color(0, 102, 204)), "n\u00B0 T\u00E9l\u00E9phone", TitledBorder.LEADING, TitledBorder.ABOVE_TOP, null, new Color(0, 0, 0)));
        textField_Telephone.setBounds(33, 305, 190, 40);
        panel.add(textField_Telephone);
        
        textField_Mail = new JTextField();
        textField_Mail.setColumns(10);
        textField_Mail.setBorder(new TitledBorder(new LineBorder(new Color(0, 102, 204)), "Mail", TitledBorder.LEADING, TitledBorder.ABOVE_TOP, null, new Color(0, 0, 0)));
        ...
        textField_DateN.setBorder(new TitledBorder(new LineBorder(new Color(0, 102, 204)), "Date de naissance", TitledBorder.LEADING, TitledBorder.ABOVE_TOP, null, new Color(0, 0, 0)));
        textField_DateN.setBounds(33, 356, 190, 40);
        panel.add(textField_DateN);
        
        textField_Id = new JTextField();
        textField_Id.setColumns(10);
        textField_Id.setBorder(new TitledBorder(new LineBorder(new Color(0, 102, 204)), "Identifiant", TitledBorder.LEADING, TitledBorder.ABOVE_TOP, null, new Color(0, 0, 0)));
