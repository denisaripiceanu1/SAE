...
public class Fenetre_InsertionAssurance extends JInternalFrame {
    ...
    public Fenetre_InsertionAssurance() {
        ...
        // Champs de saisie pour date d'échéance
        ...
        this.table_entreprise.setModel(
                new DefaultTableModel(new Object[][] { { null, null }, }, new String[] { "SIRET", "Nom" }));
