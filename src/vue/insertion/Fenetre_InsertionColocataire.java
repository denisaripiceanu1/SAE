...
public class Fenetre_InsertionColocataire extends JInternalFrame {
	...
	public Fenetre_InsertionColocataire() {
		...
		this.textField_Tel.setBorder(new TitledBorder(new LineBorder(new Color(0, 102, 204)), "N\u00B0T\u00E9lephone",
				TitledBorder.LEADING, TitledBorder.ABOVE_TOP, null, new Color(0, 0, 0)));
		this.textField_Tel.setBounds(332, 122, 190, 40);
		...
		this.textField_email.setBorder(new TitledBorder(new LineBorder(new Color(0, 102, 204)), "E-mail",
				TitledBorder.LEADING, TitledBorder.ABOVE_TOP, null, new Color(0, 0, 0)));
		this.textField_email.setBounds(332, 172, 190, 40);
		...
		btn_ajouter_colocataire.addActionListener(this.gestionClic);
		...
		btn_annuler_colocataire.addActionListener(this.gestionClic);
	...
	public GestionInsertionColocataire getGestionClic() {
