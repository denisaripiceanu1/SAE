...
public class Fenetre_InsertionDiagnostic extends JInternalFrame {
	...
	public Fenetre_InsertionDiagnostic() {
		...
		textField_Date_Validite.setBorder(new TitledBorder(new LineBorder(new Color(0, 102, 204)), "Date Validite",
		...
		textField_Type.setBorder(new TitledBorder(new LineBorder(new Color(0, 102, 204)), "Type", TitledBorder.LEADING,
