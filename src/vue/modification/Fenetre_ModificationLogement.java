...
public class Fenetre_ModificationLogement extends JInternalFrame {
	...
	public Fenetre_ModificationLogement() {
		...
		separator_titreInsererLogement.setBounds(271, 72, 190, 17);
		panel.add(separator_titreInsererLogement);

		Utils.creerLabel("Modifier un logement", 290, 25, 171, 48, 16, panel);
		...
		// Boutons généraux
		JButton btnModifier = Utils.creerBouton(panel, "Modifier", 235, 445, 94, 31);
